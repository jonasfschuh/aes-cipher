...
x  b) Permitir que o usu�rio possa informar o nome do arquivo de destino a ser gerado;
   c) Permitir que o usu�rio forne�a a chave de criptografia. Deve ser um campo texto em que possa ser fornecido os
   valores dos bytes da chave, separando os bytes por v�rgula. Por exemplo: este � um texto que deve ser poss�vel 
   fornecer para indicar os bytes da chave: ?20,1,94,33,199,0,48,9,31,94,112,40,59,30,100,248?;
   d) Implementar o modo de opera��o ECB e tamanho de chave de 128 bits;
   e) Implementar o modo de preenchimento PKCS#7;
   f) A solu��o n�o pode ser c�pia de outros autores e deve utilizar a abordagem vista em sala de aula
...
public class Trabalho {
    ...
    public void executarLeituraDados() {
        ...
        System.out.println("Informe o caminho do arquivo de sa�da . Ex: c:\\temp\\saida.txt");
